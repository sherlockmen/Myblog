...
<
    div
    className = 'fixed-header fixed w-100 top-0 left-0 pv2 z-2'
    style = {
    {
...
<
    div
    className = 'ph4 mw7 center white' >
        < a
    ...
    href = 'https://github.com/tscanlin/tocbot' >
        ...
        < /a>
        < a
    className = 'white no-underline f6 ml2'
    href = {`https://github.com/tscanlin/tocbot/releases/tag/v${pkg.version}`
}>
    {
        `v${pkg.version}`
    }
<
    ...
    < div
    className = 'mw7 center dark-gray lh-copy' >
        < input
    id = 'toc'
    type = 'checkbox'
    className = 'dn' / >
        < label
    className = 'toc-icon relative pointer z-2 f6 lh-solid bg-near-white b--silver pa1 ma1 ba br1'
    htmlFor = 'toc' >
        Menu
        < /label>
        < nav
