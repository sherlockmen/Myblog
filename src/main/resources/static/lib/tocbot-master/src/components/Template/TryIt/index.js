...
export default class TryIt extends React.Component {
    ...
    render() {
        ...
        return (
            < div
        className = {`try-it-container transition--300 fixed w-20 ma2 z-3 bottom-0 right-0 ${this.state.open ? 'is-open' : 'is-closed'}`
    }>
    <
        div
        className = 'cb pb2' >
