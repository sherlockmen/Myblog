...
function Hero(props) {
    return (
        < div
    className = 'hero relative overflow-hidden tc z-3'
    style = {
    {
...
<
    div
    className = 'hero-inner relative mw7 center white pv4' >
        < div
    ...
    className = 'pv4' >
        < h1
    className = 'title normal ma0 pa0' >
        {props.title}
        < /h1>
        < h4
    className = 'subtitle normal o-90 ma0 pa3' >
        {props.subtitle}
        < /h4>
        < div
    className = 'mv2 ml4' >
