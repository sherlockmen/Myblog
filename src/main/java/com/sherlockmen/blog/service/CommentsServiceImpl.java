...
import com.sherlockmen.blog.dao.CommentsRepository;
...
public class CommentsServiceImpl implements CommentsService{
    ...
    public List<Comment> listCommentByBlogId(Long blogId) {
        ...
        Sort sort = JpaSort.unsafe(Sort.Direction.ASC,"createTime");
        List<Comment> comments = commentsRepository.findByBlogIdAndParentCommentNull(blogId,sort);
